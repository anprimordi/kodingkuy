...
class KuisActivity : AppCompatActivity() {
    ...
    private fun countAndShowScore() {
        ...
        TTFancyGifDialog.Builder(this)
                ...
                .isCancellable(false)
                .setPositiveBtnText(R.string.action_selesai.toString())
                .setPositiveBtnBackground(R.color.colorAccent.toString())
                .setNegativeBtnText(R.string.action_ulangi.toString())
                .setNegativeBtnBackground(R.color.colorTriadic.toString())
